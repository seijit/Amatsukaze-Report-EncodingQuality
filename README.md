...
リファレンスは評価対象と同じフィルタ設定かつロスレスでエンコードして事前に用意します。
...
(オプション) 画質評価レポートに使用するデータ/SSIMU2データをJSONで保存
...
* [MediaInfo (CLI)](https://mediaarea.net/ja/MediaInfo/Download/Windows) (オプション): 環境変数 PATH が通っていること
