...
call ".\Get-MediaInfo.cmd" "%%OUT_PATH_WITHOUT_EXTENSION%%%%OUT_EXTENSION%%"
call ".\Get-MediaInfo.cmd" "%%IN_PATH%%" "%%OUT_DIR%%"
::call ".\Get-MediaInfo.cmd" "%%OUT_PATH_WITHOUT_EXTENSION%%%%OUT_EXTENSION%%" "%%OUT_DIR%%" "HTML" ".MediaInfo.html"
::call ".\Get-MediaInfo.cmd" "%%IN_PATH%%" "%%OUT_DIR%%" "HTML" ".MediaInfo.html"
